...
class FormThemeRecommendationsForUserToStudyAgent(ScAgentClassic):
    ...
    def run(self, action_node: ScAddr) -> ScResult:
        ...
        generated_struct = self.set_theme_recommendations_for_study(good_themes, bad_themes, other_themes)
        if generated_struct.is_valid():
            self.logger.info("FormThemeRecommendationsForUserToStudyAgent: recommendations are generated")
    ...
    def is_recommended_theme(self, theme: ScAddr, themes_dict: dict) -> bool:
    ...
    def set_theme_recommendations_for_study(self, good_themes: ScAddr, bad_themes: ScAddr, other_themes: ScAddr) -> ScAddr:
        ...
        templ.triple(
            ...
            sc_type.VAR_PERM_POS_ARC,
            (sc_type.VAR_NODE, "_recommendations_set")
        )
        templ.quintuple(
            "_recommendations_set",
            sc_type.VAR_PERM_POS_ARC,
            good_themes_set,
            sc_type.VAR_PERM_POS_ARC,
