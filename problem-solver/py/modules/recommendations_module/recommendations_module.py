...
from .form_theme_recommendations_for_user_to_solve_test_or_problem_agent import FormThemeRecommendationsForUserToSolveTestOrProblemAgent
...
class RecommendationsModule(ScModule):
    def __init__(self):
        super().__init__(
            ...
            FormThemeRecommendationsForUserToSolveTestOrProblemAgent()
        )