...
class StartTestAgent(ScAgentClassic):
    ...
    def run(self, action: ScAddr) -> ScResult:
        ...
        constr.generate_connector(sc_type.CONST_PERM_POS_ARC, ScKeynodes.resolve("nrel_current_test", sc_type.CONST_NODE_NON_ROLE), "arc_to_test")
        ...
        constr.generate_connector(sc_type.CONST_PERM_POS_ARC, ScKeynodes.resolve("rrel_last", sc_type.CONST_NODE_ROLE), "arc_from_pth2q")

        constr.generate_connector(sc_type.CONST_PERM_POS_ARC, "question", user, "arc_to_user")
        constr.generate_connector(sc_type.CONST_PERM_POS_ARC, ScKeynodes.resolve("rrel_passer", sc_type.CONST_NODE_ROLE), "arc_to_user")
    ...
    def remove_current_test(self, user: ScAddr):
        ...
        templ.quintuple(
            ...
            sc_type.VAR_NODE,
            sc_type.VAR_PERM_POS_ARC,
            ScKeynodes.resolve("nrel_current_test", sc_type.CONST_NODE_NON_ROLE)
        )
